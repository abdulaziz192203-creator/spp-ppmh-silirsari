  ...
  return (
    <div className="min-h-screen bg-slate-50 -mt-24 -mx-6 md:-mx-12 pb-24 md:pb-12">
      <div className="bg-blue-600 bg-gradient-to-b from-blue-700 to-blue-600 rounded-b-[40px] pt-24 pb-12 px-6 shadow-2xl relative overflow-hidden text-center flex flex-col items-center">
         ...
         <h1 className="text-3xl font-bold font-outfit text-white relative z-10 uppercase tracking-wide">Perizinan Santri</h1>
      </div>
      ...
      <div className="px-6 pt-20 flex flex-col items-center justify-center text-center">
        <motion.div 
          ...
          className="h-24 w-24 bg-blue-50 text-blue-600 rounded-[32px] flex items-center justify-center mb-6 shadow-sm border border-blue-100"
        >
        ...
        <p className="text-slate-500 max-w-xs text-sm font-medium">
          Kami sedang mempersiapkan halaman <span className="text-blue-600">Perizinan Santri</span> untuk memberikan pengalaman terbaik bagi Anda.
        </p>
        <button 
